...
BEGIN
    ...
    INSERT INTO contab.diario (
       ...
       data_vencto, valor_total, valor_custo,
        valor_imposto, desconto, outros, status, lote_id , transacao_id , contabil_id, pagar_id
    )
    SELECT 
        empresa_id, data_mov, modelo_codigo, historico, doc_ref,
         data_vencto, valor_total, valor_custo,
        valor_imposto, 0, outros, 'rascunho', lote_id , transacao_id , contabil_id, pagar_id
    FROM contab.diario_staging
    WHERE empresa_id = p_empresa_id
