...
ALTER TABLE contab.diario
ADD COLUMN pagar_id BIGINT;

Com índice:

CREATE INDEX idx_diario_empresa_pagar
ON contab.diario (empresa_id, pagar_id)
WHERE pagar_id IS NOT NULL;
...
CREATE INDEX idx_diario_staging_empresa_pagar
ON contab.diario_staging (empresa_id, pagar_id)
WHERE pagar_id IS NOT NULL;
